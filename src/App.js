  ...
  return (
    <div className="App">
      ...
      <div className="search-bar-box">
        ...
        <div
          className="guest-box"
          style={{ marginLeft: 8, display: 'flex', alignItems: 'center', background: '#fff', borderRadius: 16, padding: '10px 20px 10px 14px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', minWidth: 180, userSelect: 'none', position: 'relative' }}
        >
